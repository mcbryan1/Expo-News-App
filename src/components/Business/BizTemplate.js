...
import { Text, StyleSheet, View, TouchableOpacity, Image , Dimensions, Linking} from "react-native";
import { FontAwesome5 } from "@expo/vector-icons";
const { width, height } = Dimensions.get("window");
import image from '../../../assets/images/apple.jpg'
export default class BizTemplateTemplate extends Component {
  render() {
    return (
      <View style={styles.news__card}>
        ...
        <View style={styles.news__card__text__container}>
          <View style={styles.news__card__text}>
            ...
            >
              <Text numberOfLines={1} style={styles.news__card__time}>{this.props.date}</Text>
              <Text numberOfLines={1} style={styles.news__card__source}>{this.props.source}</Text>
            </View>
...
const styles = StyleSheet.create({
    news__card: {
      ...
      share__button: {
        position: "absolute",
        backgroundColor: "rgba(59,3,64,0.9)",
        alignSelf: "flex-end",
        padding: 15,
        borderRadius: 50,
        top: 2,
